...
const problemPages = [
  ...
  },
  {
    ...
    painStatement: "Product and Engineering misalignment appears when both teams are busy but disagree about customer value, technical feasibility, priorities, or who owns the decision.",
    dailyScenes: [
      "A product launch reaches the handoff and Engineering says the solution is not technically feasible, while Product says it no longer solves the market problem.",
      "Roadmap conversations turn into translation sessions; the VP R&D or CTO becomes the referee instead of the person setting direction.",
      "The same disagreement returns in the next sprint because ownership boundaries and decision rights were never made explicit.",
    ],
    whatTheyTried: [
    ...
    whyItFailed: "Two explanations can fit the same symptom. The first is a communication gap: the teams need earlier discovery and a shared workspace. The second is a decision-model gap: they are measured on different outcomes and no one owns the trade-off between customer value and technical feasibility. More meetings may help the first case, but they will not solve the second. A counter-example matters: a team can disagree productively when decision ownership is clear; disagreement itself is not proof of misalignment.",
    diagnosis:
    ...
    evidenceBlock: {
      claim: "Product and Engineering alignment improves when a live incident is used to test competing explanations, clarify decision rights, and run a reversible experiment.",
      source: "docs/seed-content/the-push-methodology.md",
      relatedEntity: "The Push",
      confidence: "high",
      approvalStatus: "approved",
    ...
    primaryCTA: {
      label: "Bring one current case",
      href: "/player-trap",
      reason: "Use one live incident to get a hypothesis and a small reversible experiment before deciding on coaching.",
    },
    relatedFrameworks: [
      {
        label: "The Push methodology",
    ...
    seoTitle: "Product and Engineering Misalignment: Decision Rights and Alignment | The Push",
    seoDescription: "Why Product and Engineering teams stay misaligned, how to separate communication from decision-rights problems, and one reversible experiment for leaders.",
    status: "published" as const,
    humanApproved: true,
    indexable: true,
